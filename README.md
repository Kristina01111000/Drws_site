...
- go over the edits dr w sent back for wellness check
	-Looks good. Just have first grouping’s right margin the same as the two below it. If need be the having processed foods in your house -> in home    if space needed. Try to get the lower two at same right margins. The Sponsored by…. Make it significantly larger font; perhaps all centered. The next line - make it the Learn more… = have its font a bit smaller than the one above it. And the same size as the next line. Have that line be: Try his….
